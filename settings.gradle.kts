...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("fawe.bom", "com.intellectualsites.bom", "bom-newest").version("1.42")
            ...
            library("redis", "org.redisson","redisson").version("3.27.1")
            ...
            plugin("run.server","xyz.jpenilla.run-paper").version("2.2.3")
